// GardenModal.tsx - React Component Sketch
// Sprint: Sprout System
// Purpose: Quick view of user's sprout contributions
...
const StatusBadge: React.FC<{ status: string }> = ({ status }) => {
  const styles: Record<string, string> = {
    ...
    sapling: 'bg-grove-moss/10 text-grove-moss',
    tree: 'bg-grove-amber/10 text-grove-amber',
  };
        ...
        <div className="flex flex-col h-full max-h-[70vh]">
          ...
          <div className="px-4 py-3 bg-ink/5 border-b border-ink/5">
            <div className="grid grid-cols-3 gap-3 text-center">
              ...
              <div>
                <div className="text-lg font-serif text-grove-moss">
                  0
                </div>
                <div className="text-[10px] text-ink-muted">🌿 Saplings</div>
              </div>
              <div>
                <div className="text-lg font-serif text-grove-amber">
                  0
                </div>
