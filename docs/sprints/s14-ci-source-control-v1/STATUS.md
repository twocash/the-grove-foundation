...
| ID | Title | Priority |
|----|-------|----------|
| US-001 | Version Controlled Skills | P0 |
| US-002 | One-Command Sync | P0 |
| US-003 | PR Review for Skills | P0 |
| US-004 | Multi-Machine Consistency | P1 |

---

**Sprint Folder:** `docs/sprints/s14-ci-source-control-v1/`
