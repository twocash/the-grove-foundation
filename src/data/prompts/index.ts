...
import highlightPromptsRaw from './highlights.prompts.json'; // Sprint: kinetic-highlights-v1

// Extract prompts array from highlight wrapper (has { prompts: [...] } structure)
const highlightPrompts = (highlightPromptsRaw as { prompts: PromptObject[] }).prompts || [];
...
export const libraryPrompts: PromptObject[] = [
  ...
  ...highlightPrompts, // Sprint: kinetic-highlights-v1
];
...
export { basePrompts, drChiangPrompts, wayneTurnerPrompts, highlightPrompts, highlightPromptsRaw };
