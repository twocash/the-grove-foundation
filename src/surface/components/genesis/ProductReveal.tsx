      ...
      <div className="flex-1 overflow-y-auto flex flex-col justify-center px-6 py-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className={`transition-all duration-1000 delay-300 ${
            ...
            {/* Three Pillars */}
            <div className="flex flex-col sm:flex-row justify-center gap-6 sm:gap-10 md:gap-14 mb-8">
              {pillars.map((pillar, index) => (
                ...
                >
                  <span className="text-3xl md:text-4xl mb-2">{pillar.emoji}</span>
            ...
            <p className="font-serif text-lg md:text-xl text-ink-muted italic max-w-2xl mx-auto mb-8">
