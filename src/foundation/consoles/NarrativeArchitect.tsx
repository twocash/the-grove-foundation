...
// Foundation-styled wrapper for Narrative Engine v2
// Note: This wraps the existing NarrativeConsole components during migration
// Full Foundation styling will be applied incrementally
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        {/* Right Column - Cards Grid & Editor */}
