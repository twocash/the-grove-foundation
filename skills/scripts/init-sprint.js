 ...
 * 
 * Usage: node init-sprint.js <sprint-name> [--path <output-dir>]
 * 
 * Example: node init-sprint.js feature-flags-v1 --path ./docs/sprints
 */
...
if (!sprintName) {
  console.error('Usage: node init-sprint.js <sprint-name> [--path <output-dir>]');
  console.error('Example: node init-sprint.js feature-flags-v1 --path ./docs/sprints');
  process.exit(1);
}
